...
public class SeleTest {
     ...
     * However, since now we are only invoking a single test method and testNG does not support running sigle test
    ...
    private static class TestCase {
        ...
        /**
         * @return Test Object information array in a list, each test object array contains different group id
         * ranging from 1 to this.groupCount
         */
