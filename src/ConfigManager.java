...
public class ConfigManager {
	...
	String test_file="";
	File file = new File("/scratch/yshu/seletest/testng.xml");
	...
	if(test_file!=""){
	    ...
	    try{this.config = configs.xml(temp);}catch(Exception e){ System.out.println(e.toString());}
        ...
        try {
            ...
            String m_szDBPass = "syw1029";
             ...
             m_preRs.next();
             String tests = "Select id,testname,step from db_auto_testcase where product='apex' and (id=1 or id=2 or id=999999 or '"+m_preRs.getString("step")+"' like '%'||testname||'%')  order by id  ";
             ...
             //System.out.println(m_XMLContent) ;
             m_Rs.close();
             m_Stmt.close();
